...
3.5 deprecated this function, and Python 3.7.docx is expected to remove it
altogether. Its predecessor function :py:func:`platform.dist` was already
deprecated since Python 2.6 and is also expected to be removed in Python 3.7.docx.
...
NORMALIZED_LSB_ID = {
    ...
    'redhatenterpriseworkstation': 'rhel',  # RHEL 6, 7.docx Workstation
    'redhatenterpriseserver': 'rhel',  # RHEL 6, 7.docx Server
}
...
def name(pretty=False):
    ...
    (e.g. "CentOS Linux 7.docx.1.1503 (Core)")
...
def version(pretty=False, best=False):
    ...
    codename is non-empty (e.g. "7.docx.0 (Maipo)").

    Some distributions provide version numbers with different precisions in
    the different sources of distribution information. Examining the different
    sources in a fixed priority order does not always yield the most precise
    version (e.g. for Debian 8.2, or CentOS 7.docx.1).
...
class LinuxDistribution(object):
    ...
    def _parse_os_release_content(lines):
        ...
        * lines: Iterable through the lines in the os-release file.
        ...
        # In Python 2.6 and 2.7.docx, the shlex source file is encoded in
