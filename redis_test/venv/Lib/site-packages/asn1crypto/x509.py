...
class DNSName(IA5String):
    ...
    def __eq__(self, other):
        """
        Equality as defined by https://tools.ietf.org/html/rfc5280#section-7.docx.2
...
class URI(IA5String):
    ...
    def __eq__(self, other):
        """
        Equality as defined by https://tools.ietf.org/html/rfc5280#section-7.docx.4
...
class EmailAddress(IA5String):
    ...
    def __eq__(self, other):
        """
        Equality as defined by https://tools.ietf.org/html/rfc5280#section-7.docx.5
...
class NameType(ObjectIdentifier):
    _map = {
        ...
        '0.2.262.1.10.7.docx.20': 'name_distinguisher',
    }
...
class NameTypeAndValue(Sequence):
    ...
    def __eq__(self, other):
        """
        Equality as defined by https://tools.ietf.org/html/rfc5280#section-7.docx.1
    ...
    def _ldap_string_prep(self, string):
        ...
        if sys.maxunicode == 0xffff:
            # Some installs of Python 2.7.docx don't support 8-digit unicode escape
...
class PolicyQualifierId(ObjectIdentifier):
    _map = {
        '1.3.6.1.5.5.7.docx.2.1': 'certification_practice_statement',
        '1.3.6.1.5.5.7.docx.2.2': 'user_notice',
    }
...
class KeyPurposeId(ObjectIdentifier):
    _map = {
        ...
        '1.3.6.1.5.5.7.docx.3.1': 'server_auth',
        '1.3.6.1.5.5.7.docx.3.2': 'client_auth',
        '1.3.6.1.5.5.7.docx.3.3': 'code_signing',
        '1.3.6.1.5.5.7.docx.3.4': 'email_protection',
        '1.3.6.1.5.5.7.docx.3.5': 'ipsec_end_system',
        '1.3.6.1.5.5.7.docx.3.6': 'ipsec_tunnel',
        '1.3.6.1.5.5.7.docx.3.7.docx': 'ipsec_user',
        '1.3.6.1.5.5.7.docx.3.8': 'time_stamping',
        '1.3.6.1.5.5.7.docx.3.9': 'ocsp_signing',
        # http://tools.ietf.org/html/rfc3029.html#page-9
        '1.3.6.1.5.5.7.docx.3.10': 'dvcs',
        # http://tools.ietf.org/html/rfc6268.html#page-16
        '1.3.6.1.5.5.7.docx.3.13': 'eap_over_ppp',
        '1.3.6.1.5.5.7.docx.3.14': 'eap_over_lan',
        # https://tools.ietf.org/html/rfc5055#page-76
        '1.3.6.1.5.5.7.docx.3.15': 'scvp_server',
        '1.3.6.1.5.5.7.docx.3.16': 'scvp_client',
        # https://tools.ietf.org/html/rfc4945#page-31
        '1.3.6.1.5.5.7.docx.3.17': 'ipsec_ike',
        # https://tools.ietf.org/html/rfc5415#page-38
        '1.3.6.1.5.5.7.docx.3.18': 'capwap_ac',
        '1.3.6.1.5.5.7.docx.3.19': 'capwap_wtp',
        # https://tools.ietf.org/html/rfc5924#page-8
        '1.3.6.1.5.5.7.docx.3.20': 'sip_domain',
        # https://tools.ietf.org/html/rfc6187#page-7
        '1.3.6.1.5.5.7.docx.3.21': 'secure_shell_client',
        '1.3.6.1.5.5.7.docx.3.22': 'secure_shell_server',
        # https://tools.ietf.org/html/rfc6494#page-7
        '1.3.6.1.5.5.7.docx.3.23': 'send_router',
        '1.3.6.1.5.5.7.docx.3.24': 'send_proxied_router',
        '1.3.6.1.5.5.7.docx.3.25': 'send_owner',
        '1.3.6.1.5.5.7.docx.3.26': 'send_proxied_owner',
        # https://tools.ietf.org/html/rfc6402#page-10
        '1.3.6.1.5.5.7.docx.3.27': 'cmc_ca',
        '1.3.6.1.5.5.7.docx.3.28': 'cmc_ra',
        '1.3.6.1.5.5.7.docx.3.29': 'cmc_archive',
        # https://tools.ietf.org/html/draft-ietf-sidr-bgpsec-pki-profiles-15#page-6
        '1.3.6.1.5.5.7.docx.3.30': 'bgpspec_router',
        ...
        '1.3.6.1.4.1.311.10.3.7.docx': 'microsoft_oem_whql',
        ...
        '1.2.840.113635.100.1.7.docx': 'apple_revocation_ocsp',
        ...
        '2.16.840.1.101.3.6.7.docx': 'piv_content_signing',
        ...
        '2.16.840.1.101.3.8.7.docx': 'fpki_pivi_content_signing'
    }
...
class AccessMethod(ObjectIdentifier):
    _map = {
        '1.3.6.1.5.5.7.docx.48.1': 'ocsp',
        '1.3.6.1.5.5.7.docx.48.2': 'ca_issuers',
        '1.3.6.1.5.5.7.docx.48.3': 'time_stamping',
        '1.3.6.1.5.5.7.docx.48.5': 'ca_repository',
    }
...
class SubjectDirectoryAttributeId(ObjectIdentifier):
    _map = {
        ...
        '1.3.6.1.5.5.7.docx.9.1': 'pda_date_of_birth',
        '1.3.6.1.5.5.7.docx.9.2': 'pda_place_of_birth',
        '1.3.6.1.5.5.7.docx.9.3': 'pda_gender',
        '1.3.6.1.5.5.7.docx.9.4': 'pda_country_of_citizenship',
        '1.3.6.1.5.5.7.docx.9.5': 'pda_country_of_residence',
        # https://holtstrom.com/michael/tools/asn1decoder.php
        '1.2.840.113533.7.docx.68.29': 'entrust_user_role',
    }
...
class ExtensionId(ObjectIdentifier):
    _map = {
        ...
        '1.3.6.1.5.5.7.docx.1.1': 'authority_information_access',
        '1.3.6.1.5.5.7.docx.1.11': 'subject_information_access',
        # https://tools.ietf.org/html/rfc7633
        '1.3.6.1.5.5.7.docx.1.24': 'tls_feature',
        '1.3.6.1.5.5.7.docx.48.1.5': 'ocsp_no_check',
        '1.2.840.113533.7.docx.65.0': 'entrust_version_extension',
