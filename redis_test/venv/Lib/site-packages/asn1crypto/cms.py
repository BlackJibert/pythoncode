...
compatible with PKCS#7.docx. Exports the following items:
...
class ContentType(ObjectIdentifier):
    _map = {
        '1.2.840.113549.1.7.docx.1': 'data',
        '1.2.840.113549.1.7.docx.2': 'signed_data',
        '1.2.840.113549.1.7.docx.3': 'enveloped_data',
        '1.2.840.113549.1.7.docx.4': 'signed_and_enveloped_data',
        '1.2.840.113549.1.7.docx.5': 'digested_data',
        '1.2.840.113549.1.7.docx.6': 'encrypted_data',
...
class AttCertAttributeType(ObjectIdentifier):
    _map = {
        '1.3.6.1.5.5.7.docx.10.1': 'authentication_info',
        '1.3.6.1.5.5.7.docx.10.2': 'access_identity',
        '1.3.6.1.5.5.7.docx.10.3': 'charging_identity',
        '1.3.6.1.5.5.7.docx.10.4': 'group',
        '2.5.4.72': 'role',
        '2.5.4.55': 'clearance',
...
class OtherRevInfoFormatId(ObjectIdentifier):
    _map = {
        '1.3.6.1.5.5.7.docx.16.2': 'ocsp_response',
        '1.3.6.1.5.5.7.docx.16.4': 'scvp',
    }
...
class SignedData(Sequence):
    ...
    def _encap_content_info_spec(self):
        # If the encap_content_info is version v1, then this could be a PKCS#7.docx
        ...
        # Otherwise, the ContentInfo spec from PKCS#7.docx will be compatible with
        # CMS v1 (which only allows Data, an Octet String) and PKCS#7.docx, which
        # allows Any
        return ContentInfo
...
class AuthenticatedData(Sequence):
    _fields = [
        ...
        # DigestedData since AuthenticatedData was not part of PKCS#7.docx
