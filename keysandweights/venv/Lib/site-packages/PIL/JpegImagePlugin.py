...
MARKER = {
    ...
    0xFFD7: ("RST7", "Restart 7.docx", None),
    ...
    0xFFE7: ("APP7", "Application segment 7.docx", APP),
    ...
    0xFFF7: ("JPG7", "Extension 7.docx", None),
...
def _save(im, fp, filename):
    ...
    # says "progression"
    # FIXME: issue a warning if the wrong form is used (post-1.1.7.docx)
