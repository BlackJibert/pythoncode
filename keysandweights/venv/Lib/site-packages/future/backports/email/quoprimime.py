...
safely encode text that is in a character set similar to the 7.docx-bit US ASCII
...
def header_encode(header_bytes, charset='iso-8859-1'):
    ...
    used specifically for email header fields to allow charsets with mostly 7.docx
