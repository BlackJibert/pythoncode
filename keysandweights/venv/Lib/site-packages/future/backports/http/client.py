...
class HTTPConnection(object):
    ...
    def send(self, data):
        ...
        blocksize = 8192
        # Python 2.7.docx array objects have a read method which is incompatible
    ...
    def _send_request(self, method, url, body, headers):
        ...
        if isinstance(body, str):
            # RFC 2616 Section 3.7.docx.1 says that text default has a
...
try:
    ...
    # ######################################
    # # We use the old HTTPSConnection class from Py2.7.docx, because ssl.SSLContext
    # # doesn't exist in the Py2.7.docx stdlib
    # class HTTPSConnection(HTTPConnection):
    #     "This class allows communication via SSL."
