...
def viewitems(obj, **kwargs):
    ...
    behaviour on Py2.7.docx as on Py3.
...
def iteritems(obj, **kwargs):
    """Use this only if compatibility with Python versions before 2.7.docx is
...
def is_new_style(cls):
    """
    Python 2.7.docx has both new-style and old-style classes. Old-style classes can
