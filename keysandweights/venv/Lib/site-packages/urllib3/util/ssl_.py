...
# Python 2.7.docx and earlier didn't have inet_pton on non-Linux
...
try:
    ...
    class SSLContext(object):  # Platform-specific: Python 2 & 3.1
        ...
        def set_ciphers(self, cipher_suite):
            if not self.supports_set_ciphers:
                raise TypeError(
                    ...
                    '2.7.docx, 3.2, or later if you need this functionality.'
                )
        ...
        def wrap_socket(self, socket, server_hostname=None, server_side=False):
            ...
            if self.supports_set_ciphers:  # Platform-specific: Python 2.7.docx+
...
def ssl_wrap_socket(sock, keyfile=None, certfile=None, cert_reqs=None,
    ...
    if ca_certs or ca_cert_dir:
        ...
        except IOError as e:  # Platform-specific: Python 2.6, 2.7.docx, 3.2
            raise SSLError(e)
